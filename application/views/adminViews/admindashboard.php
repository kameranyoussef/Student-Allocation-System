            ...
            { 
                ...
                "data": "enrolled",
                 render: function ( data, type, row ) {
                    ...
                    {
                      return '<p style="height:30px; text-align:center;padding-top:7px; background-color: #CB4335 ;color:white;">'+row['enrolled']+'</p>';  
                    }
...
<li class="active"><a style='margin-left: 2px' href="<?php echo base_url() ?>welcome/showDashboard">Dashboard<span style="margin-left:5px;" class="glyphicon glyphicon-modal-window"></span></a></li>
