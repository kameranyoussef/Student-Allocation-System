...
$(document).ready(function() {
        ...
        "searching":false,
         "ajax": {
            "url": "<?= base_url(); ?>index.php/welcome/HistoryRecord",
            "type": "POST"
          ...
          { 
            ...
            { 
                ...
                "data": "State", render: function ( data, type, row ) {
                    ...
                    {
                        return '<p  style="height:30px; text-align:center;padding-top:7px; background-color: #0dd453 ;color:white;">'+data+'</p>';
                    } 
...
function filter()
{
  ...
  var state=document.getElementById('stateID').value;
    ...
    $('#projTable').DataTable( {
        ...
        "responsive": true,
         "ajax": {
            "url": "<?= base_url(); ?>index.php/welcome/filterHistoryRecord",
            "type": "POST",
            "data": {"title":title,"student":student,"supervisor":supervisor,"state":state},
...
<body>
  ...
  <li class="active"><a style='margin-left: 2px' href="<?php echo base_url() ?>welcome/showHistory">History<span style="margin-left:5px;" class="glyphicon glyphicon-modal-window"></span></a></li>
  ...
  <li style="float: right;"><h4>Admin Panel</h4></li>
        ...
        <div class="main" >
            ...
            <div class='col-md-10'>
                ...
                <div class="col-md-3">
                <input class="form-control" type="text" name="supID" id="supID" placeholder="Search by Supervisor" onkeyup='filter();'>
                </div>
