...
<body>
  ...
  <br>
   ...
   <div class='col-md-12'>
     ...
     <form  action="<?php echo base_url(); ?>Users/saveNewStudent" method="Post" >

      <div style='border:solid;background-color: #fbfcfc;border-color:lightgrey;border-width:0.5;'>

         <h2 style="padding: 10px">Student Details</h5>
          ...
          <div class="col-md-12">
                        ...
                        <div class='row' style="padding: 20px;">
                           ...
                           <div class="col-md-3" style="margin-left: 10px;">
                              ...
                              <div class="form-group" >
                                     ...
                                     <input required type="text" style="width: 250px;height:30px;" class="form-control" id="uName" placeholder="Enter username" name="uName">
                              </div>  
                           </div>
                            ...
                            <div class='col-md-3'>
                             ...
                             <div class="col-md-3" style="margin-left:10px;">
                              ...
                              <div class="form-group" >
                                     ...
                                     <input required type="text" style="width: 250px;height:30px;" class="form-control" id="fname" placeholder="Father name" name="fname">
                              </div>  
                        ...
                        <div class="row" style="padding: 20px;margin-top: -20px;">
                          ...
                          <textarea style="width: 250px;height: 100px;" id='stdAddress' name='stdAddress' placeholder="Permenant Address">
                          </textarea>
                          </div>
