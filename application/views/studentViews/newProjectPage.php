...
<body>
  ...
  <!---<div class="main" style="margin-top:-20px;">-->
   ...
   <div class='col-md-12'>
     ...
     <form  style="margin-left: 80px;" action="<?php echo base_url(); ?>student/saveStudentProject" method="Post" >

      <div style='border:solid;background-color: #fbfcfc;border-color:lightgrey;border-width:0.5;'>

         <h2 style="padding: 10px">Apply for Project</h5>
          ...
          <div class="col-md-12">
                        ...
                        <div class='row' style="padding: 20px;">
                            ...
                            <div class='col-md-3'>
                              ...
                              <?php 
                               echo "<select class='form-control' id='supID' name='supID' style='width: 250px;height:30px;' onchange='getSupervisor(id)'>";
                            ...
                            <div class='col-md-3'>
                              <label for="courses">Topics:</label>

                              <select class='form-control' id='stdTopic' name='stdTopic'onchange="topicDetail(id)" style='width: 250px;height:30px;'>
                              </select>
                        ...
                        <div class="row" style="padding: 20px;">
                          ...
                          <div class="col-md-3">
                            ...
                            <textarea readonly id='desc' name='desc' style="height: 150px;width: 250px;"></textarea>
                          </div>

                           <div class="col-md-3">
                            <label>Goals</label>
                            <textarea readonly id='goal' name='goal' style="height: 150px;width: 250px;"></textarea>
                          </div>

                          <div class="col-md-3">
                            <label>Message</label>
                            <textarea  id='msg' name='msg' style="height: 150px;width: 350px;"></textarea>
                          </div>
                        </div>  
