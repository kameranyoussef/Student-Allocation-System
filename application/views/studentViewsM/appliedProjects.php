...
<body>
 ...
 <li class="active"><a style='margin-left: 2px' href="<?php echo base_url() ?>student/showMobileAppliedProjects">Applied Projects<span style="margin-left:5px;" class="glyphicon glyphicon-modal-window"></span></a></li>
