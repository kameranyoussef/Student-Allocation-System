...
<body>
 ...
 <li><a style='margin-left: 2px' href="<?php echo base_url() ?>student/showMobileTopics">Topics<span style="margin-left:5px;" class="glyphicon glyphicon-list-alt"></span></a></li>
 ...
 <li class="active"><a style='margin-left: 2px' href="<?php echo base_url() ?>student/showMobileAppointments">Appointments<span style="margin-left:5px;" class="glyphicon glyphicon-modal-window"></span></a></li>
  ...
  <!---<div class="main" style="margin-top:-20px;">-->
   ...
   <div class='col-md-12'>
     ...
     <form action="<?php echo base_url(); ?>student/saveMobileAppointment" method="Post" >
